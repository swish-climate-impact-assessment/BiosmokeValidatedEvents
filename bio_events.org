...
- the tex goes to vignette/ Rmd is going to inst/doc, then methods.tex merge with one in vignettes?
- this is confusing
- to make the package help manual
...
to inversion layers) have been hampered by the lack of availability of datasets
