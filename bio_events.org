...
#+begin_src R :session *R* :tangle inst/doc/03_calc_extreme_events.R :exports none :eval no
  #### name:03_calc_extreme_events.R ####
  # now make a view for each poll so Talia and Grant can see.
  ...
  grant select on biosmoke_pollution.",poll,"_to_check to biosmoke_user
  ",sep="")
  )
...
- Download the rpostgrestools utility package [http://swish-climate-impact-assessment.github.io/rpostgrestools/](http://swish-climate-impact-assessment.github.io/rpostgrestools/)
- install using R
